...
(0, _appFastoptJs.BMMediaApp)().doSomething();
...
/** @constructor */ function $c_Lcom_bmmedia_jobsboard_App() {
/*<skip>*/ }
$c_Lcom_bmmedia_jobsboard_App.prototype = new $h_O();
$c_Lcom_bmmedia_jobsboard_App.prototype.constructor = $c_Lcom_bmmedia_jobsboard_App;
/** @constructor */ function $h_Lcom_bmmedia_jobsboard_App() {
/*<skip>*/ }
$h_Lcom_bmmedia_jobsboard_App.prototype = $c_Lcom_bmmedia_jobsboard_App.prototype;
$c_Lcom_bmmedia_jobsboard_App.prototype.doSomething__T__V = function(containerId) {
    document.getElementById(containerId).innerHTML = "Hello World!";
};
$c_Lcom_bmmedia_jobsboard_App.prototype.$js$exported$meth$doSomething__T__O = function(containerId) {
    this.doSomething__T__V(containerId);
};
$c_Lcom_bmmedia_jobsboard_App.prototype.doSomething = function(arg) {
    var prep0 = $as_T(arg);
    return this.$js$exported$meth$doSomething__T__O(prep0);
};
var $d_Lcom_bmmedia_jobsboard_App = new $TypeData().initClass({
    Lcom_bmmedia_jobsboard_App: 0
}, false, "com.bmmedia.jobsboard.App", {
    Lcom_bmmedia_jobsboard_App: 1,
    O: 1
});
$c_Lcom_bmmedia_jobsboard_App.prototype.$classData = $d_Lcom_bmmedia_jobsboard_App;
...
$L0 = new $c_RTLong(0, 0);
$d_J.zero = $L0;
exports.BMMediaApp = function() {
    return new $c_Lcom_bmmedia_jobsboard_App();
};
